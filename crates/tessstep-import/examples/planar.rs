...
fn run() -> Result<bool, Box<dyn std::error::Error>> {
    ...
    match result {
        Ok(mesh) => {
            println!(
                "{{\"format_version\":1,\"scope\":\"planar-solid\",\"status\":\"accepted\",\"profile\":\"accepted\",\"geometry\":\"accepted\",\"tessellation\":\"accepted\",\"vertices\":{},\"triangles\":{},\"boundary_edges\":{},\"components\":{},\"volume_m3\":{}}}",
        ...
        Err(e) => {
            ...
            eprintln!("{e}");
            println!(
                "{{\"format_version\":1,\"scope\":\"planar-solid\",\"status\":\"{status}\",\"profile\":\"{profile}\",\"geometry\":\"{geometry}\",\"tessellation\":\"{tessellation}\",\"entity\":{}}}",
